		...
		<div className="min-h-screen w-full flex items-center justify-center">
			<div className="flex flex-col items-center w-full min-h-screen rounded-lg shadow-md bg-base">
				<div className="flex items-center justify-center font-semibold text-6 w-full mt-[5%] ml-[10%]">
					<Link rel="stylesheet" href="/login" ><ArrowBackIcon  className=""/></Link>
					<p className="w-full  text-center text-[24px]">ようこそ<span className="pl-[8%]">Cofitへ</span></p>
				</div>
...
<p className="">アイコン</p>
			...
			<div className="mt-[15%] w-[90%] h-[55px] shadow-[0_4px_12px_rgba(0,0,0,0.4)">
					<p className="text-sm font-medium text-[16px] text-base mb-[5%]">ユーザー名<span className="text-[#D9D9D9] ml-[5%]">半角英数字のみ</span></p>
			<input
				type="text"
				value={name}
