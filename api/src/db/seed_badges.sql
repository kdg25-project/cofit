...
(7, '腹筋100回達成', 'https://img-cofit.kdgn.tech/badge/models/bag_rank_silver.glb', '通算100回の腹筋を達成しました！', '腹筋を合計100回達成する'),
(8, '腹筋1000回達成', 'https://img-cofit.kdgn.tech/badge/models/bag_rank_gold.glb', '通算1,000回の腹筋を成し遂げました。', '腹筋を合計1,000回達成する'),
